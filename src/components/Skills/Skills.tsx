...
const Skills = (props: any) => {
  ...
  const skillsTitleClass = props.skills
    ? "skills__title"
    : "skills__title skills__title--hidden";
  // const skillsContainerClass = props.skills
  //   ? "skills-container"
  //   : "skills-container skills-container--hidden";
  const skillsContainerFrontend = props.skills
    ? "skills-container__frontend"
    : "skills-container__frontend hidden";
  const skillsContainerBackend = props.skills
    ? "skills-container__backend"
    : "skills-container__backend hidden";
  const skillsContainerTechs = props.skills
    ? "skills-container__techs"
    : "skills-container__techs hidden";
...
<div className="skills" id="skills">
      {
        <StyleRoot.StyleRoot>
          <header
            className={skillsTitleClass}
            style={animationStyles.slideInDown}
          >
      ...
      <div className="skills-container">
        ...
        }
        {
          <StyleRoot.StyleRoot>
            <div
              className={skillsContainerTechs}
              style={animationStyles.slideInRight}
            >
